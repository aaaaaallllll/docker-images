import { watch, ref, computed, getCurrentInstance, shallowRef, nextTick, defineComponent, useAttrs as useAttrs$1, useSlots, toRef, createElementBlock, openBlock, normalizeStyle, normalizeClass, unref, createCommentVNode, Fragment, createElementVNode, renderSlot, createBlock, withCtx, resolveDynamicComponent, mergeProps, withModifiers, createVNode, toDisplayString } from 'vue';
import { t as tryOnScopeDispose, q as isString, s as noop, v as resolveUnref, w as tryOnMounted, x as identity, a as useNamespace } from './server.mjs';
import { pick as pick$1, fromPairs, isNil } from 'lodash-unified';
import { b as buildProps, d as definePropType, i as iconPropType, m as useSizeProp, _ as _export_sfc, o as useFormSize, q as useFormDisabled, r as useFormItem, t as useFormItemInputId, V as ValidateComponentsMap, v as view_default, x as hide_default, g as ElIcon, y as circle_close_default, w as withInstall } from './index.mjs';
import { isString as isString$1, isFunction, NOOP } from '@vue/shared';
...
const pick = function(obj, keys, split = ".") {
  if (!obj) return;
  const keyArr = keys.split(split);
  let res = clone(obj);
...
export { ElInput as E, isValidMobile as i, mutable as m, onClickOutside as o, pick as p, useAriaProps as u };
