import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, computed, unref, onScopeDispose, nextTick, watchEffect, readonly, defineAsyncComponent, defineComponent, h, Suspense, mergeProps, provide, watch, Fragment, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'vue';
import { l as createHooks, m as getContext, f as createError$1, n as toRouteMatcher, o as createRouter, p as defu, q as hasProtocol, r as joinURL, w as withQuery, v as sanitizeStatusCode, x as isScriptProtocol, y as executeAsync, d as destr, z as klona, A as parse, B as getRequestHeader, C as isEqual, D as setCookie, E as getCookie, F as deleteCookie } from '../_/nitro.mjs';
...
const unhead_qUOzG0x1xPZI_oGW8jvXKuSQqmy5pKv93TawLvPhOPg = defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const revive_payload_server_7RsM9cY7O7LDW2UVy6bSey9FbQPV9w8jCVm3CfPS6wE = defineNuxtPlugin({
...
const element_plus_teleports_plugin_MqfudBumuoE3Pez3fuUvb8WdTojFg8JYYTQkOWOC5VM = defineNuxtPlugin((nuxtApp) => {
...
const element_plus_injection_plugin_rmo8goqVWUJloFdo3_62mQljiuVWSYSpjiB72zna6Cs = defineNuxtPlugin((nuxtApp) => {
...
const ssr_plugin_m1TbUVknTPIyqM7VD5sN8GEIXxcEQDxXUeY5k7w0P2k = defineNuxtPlugin(() => {
});

const plugins = [
  payloadPlugin,
  unhead_qUOzG0x1xPZI_oGW8jvXKuSQqmy5pKv93TawLvPhOPg,
  plugin$1,
  revive_payload_server_7RsM9cY7O7LDW2UVy6bSey9FbQPV9w8jCVm3CfPS6wE,
  plugin,
  ...
  ssr_plugin_m1TbUVknTPIyqM7VD5sN8GEIXxcEQDxXUeY5k7w0P2k
];
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_NuxtPage, { class: "font-puhui-Regular" }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_NuxtPage, { class: "font-puhui-Regular" })
            ];
          }
        }),
        _: 1
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@3.16.0_@parcel+watcher_dbaa9fe173eb7e09aa84df418d9202a5/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@3.16.0_@parcel+watcher_dbaa9fe173eb7e09aa84df418d9202a5/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { namespaceContextKey as A, zIndexContextKey as B, server as C, useNamespace as a, useId as b, useRouter as c, useRoute as d, useNuxtApp as e, useRuntimeConfig as f, nuxtLinkDefaults as g, isBoolean as h, isNumber as i, isClient as j, useGetDerivedNamespace as k, useIdInjection as l, isElement as m, navigateTo as n, useZIndex as o, baseURL as p, isString as q, resolveRouteObject as r, noop as s, tryOnScopeDispose as t, useHead as u, resolveUnref as v, tryOnMounted as w, identity as x, isStringNumber as y, isUndefined as z };
